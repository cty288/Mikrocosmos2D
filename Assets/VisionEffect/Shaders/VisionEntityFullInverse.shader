Shader "Test/2D/Sprite-Lit-Entity-Full-Inversed"
{
    Properties
    {
...
//#include "UnityCG.cginc"
          ...
          //  SAMPLER(_BackgroundTex);
            ...
            half4 CombinedShapeLightFragment(Varyings i) : SV_Target
            {
                ...
                half4 bg = CombinedShapeLightShared(main, mask, i.lightingUV.xy, i.worldPos);
                half3 background = tex2D(_BackgroundTex, screenUV);


                bg.a = 1 - bg.a;
                float alpha = bg.a;

                //half3 color = bg.xyz * alpha + background * (1 - alpha) * 2;

                //result.a = min(result.a, 0.7);
                return bg;
            }
            ENDHLSL
        }
