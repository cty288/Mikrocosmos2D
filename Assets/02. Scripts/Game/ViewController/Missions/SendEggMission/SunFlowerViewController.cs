    ...
    public class SunFlowerViewController : AbstractNetworkedController<Mikrocosmos>, ICanBuyPackageViewController {
        ...
        public override void OnStartServer()
        {
           ...
           // this.RegisterEvent<OnServerTransactionFinished>(OnServerTransactionFinished)
            ...
            this.RegisterEvent<OnMissionStop>(OnMissionStop).UnRegisterWhenGameObjectDestroyed(gameObject, true);
        ...
        private GameObject GenerateBuyBubble(int price, string bubbleToGenerate, string bubbleToDestroy, float maxTime)
        {
            ...
            bubbleScript.UpdateInfo(price, maxTime, bubbleToGenerate);
